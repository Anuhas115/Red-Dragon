...
global.ownername = "😎chathuranga(alpha)❯❯" //ur owner name
...
global.packname = "❁͜͡᭕ᵏⁱⁿᵍ᪶𝙰𝙻𝙿𝙷𝙰᳅◎⃝»̶̶͓͓͓̽̽̽❁⛄*" // sticker packname
global.author = "Bot Sticker" // sticker author
global.dragonemoji = '🧩' // Menu emoji
global.footer = '[ ◉ https://youtube.com/channel/UCIZmxh5OGrhX9tluSQBehHA ]' //In list menu
...
global.rep = { // All Replies = 145
    ...
    K40: '🙄මොනවටද ආස?',
    K41: '😌මාත් ආසයි😊💞',
    K42: 'එලම😘😍සාදරයෙන් ආදරයෙන් කෑදරයෙන් පිළිගන්නවා🙏😍🌺😌',
    ...
    K131: '😂😂🙏',
    K132: '😂🤭',
    K133: 'ගුඩ්නයිට් ❤️බුදුසරණයි ජේසු පිහිටයි පරිස්සම්න් ඉන්න❤️❤️🤗',
    K134: '😏☝️',
    K135: 'අඬන්න එපා ඉතිං😒😝',
    K136: '🥴පිත්තු',
    K137: '🙂',
